...
class Falco:
    def __init__(self, pad):
        ...
        self.ai = p3.qlearn.QLearn(actions=[], epsilon=0.95, alpha=0.33, gamma=0.95)
    ...
    def update(self, state):
        ...
        reward += 10 * p1_damage # + 1 * p3_stocks
    ...
    def pressZ(self):
        self.action_list.append((3, 'press_button', [p3.pad.Button.Z]))
